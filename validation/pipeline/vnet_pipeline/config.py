...
params['ModelParams']['snapshot']=9500
...
params['ModelParams']['dirSnapshots']=os.path.join(basePath,'3dircad-liver-models/3dircad') #where to save the models while training
